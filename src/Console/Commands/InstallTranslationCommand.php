...
namespace HavenPlus\Districts\Console\Commands;
...
class InstallTranslationCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'districts:install-translation {locale}';
     ...
     * @var string
     */
    protected $description = 'Install translations for districts';
    ...
    public function handle()
    {
        ...
        $filePath = sprintf('%s/districts.php', $storagePath);
